...
//             <div className="home-template-text-1">One place for all world of</div>
//             <div className="home-template-text-2">Great photo contest and awards</div>
//           </div>
...
//               </div>
//             </div>
//             <div className="mr-3 home-product-line"></div>
